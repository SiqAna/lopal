function urna(){
    ...
    let nulos = 0;
    let total = 0 ;
    let porcent_cand_a = 0;
    let porcent_cand_b = 0;
    let porcent_brancos = 0;
    let porcent_nulos = 0;
    let voto;
    ...
    do{
       voto = prompt("Escolha seu candidato ou tecle zero para encerrar\n" +
            ...
            " 2 -> Candidato B\n" +
            " 3 -> Branco\n" +
            "\nQualquer outro número diferente de 0, 1, 2 e 3 anulará seu voto\n" +
            "Digite seu voto: ");
     ...
     total = candidato_a + candidato_b + nulos + brancos
